...
qQuery("select * from {$_ENV['eDesDictionary']}gs_form where cd_gs_form={$cd_gs_form} && cd_gs_node={$_Node}");
$r = qArray();
...
<BODY id="ImgFondo" onselectstart="return false"<?=((SESS::$_D_=="~") ? "":' oncontextmenu="return false"')?>>
