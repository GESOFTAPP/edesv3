...
var TR,TD;
<?PHP
qQuery( "select cd_gs_img, extension, bytes,ppi,width_px,height_px,extension, nm_gs_img from {$_ENV['eDesDictionary']}gs_img where copy_of=".$CopyOf.' order by bytes' );
while($r=qArray()){
