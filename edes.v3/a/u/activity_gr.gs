...
qQuery( "select user_name, user_surname from {$_ENV['eDesDictionary']}gs_user where cd_gs_user=".$_GET['cd_gs_user'] );
$r=qRow();
...
qQuery( "select cdi from {$_ENV['eDesDictionary']}gs_activity where cdi>='".$Dia." 00:00:00' and cdi<='".$Dia." 23:59:59' order by cdi" );
}else{
qQuery( "select cdi from {$_ENV['eDesDictionary']}gs_activity where cd_gs_user=".$_GET['cd_gs_user']." and cdi>='".$Dia." 00:00:00' and cdi<='".$Dia." 23:59:59' order by cdi" );
}
while( $r=qRow() ){
