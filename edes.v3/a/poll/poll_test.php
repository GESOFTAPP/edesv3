...
qQuery("select * from {$_ENV['eDesDictionary']}gs_campaign where cd_gs_campaign=".$_GET["cd_gs_campaign"]);
$cmp = qArray();
if( $cmp["cd_gs_poll"]=="" ){
eInit();
eEnd();
...
qQuery("select * from {$_ENV['eDesDictionary']}gs_poll where cd_gs_poll=".$cmp["cd_gs_poll"]);
$r = qArray();
...
qQuery("select * from {$_ENV['eDesDictionary']}gs_question where cd_gs_poll=".$cmp["cd_gs_poll"]." order by orden");
...
qQuery("select user_name,user_surname from {$_ENV['eDesDictionary']}gs_user where cd_gs_user=".S::$_User);
...
qQuery("select * from {$_ENV['eDesDictionary']}gs_poll where cd_gs_poll=".$pk);
$r = qArray();
$txt = "";
if( $r[$texto]!="" ){
$txt = $r[$texto];
