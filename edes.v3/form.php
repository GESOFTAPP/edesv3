...
qQuery("select * {$_ENV['eDesDictionary']}form where cd_gs_form={$cd_gs_form} && cd_gs_node={$_Node}");
$r = qArray();
...
<BODY onselectstart="return false"<?=((SESS::$_D_=="~") ? "":' oncontextmenu="return false"')?>>
