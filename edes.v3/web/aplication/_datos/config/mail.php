<?PHP 
	...
	*/
	...
	function eMailSmtp($_to, $_asunto, $_texto_html, $_from, $_nm_from, $cc, $bcc, $adjuntos){
		$resultado = qQuery("select * from gesco_cnfg_emisor where cnfg_default='{$_ENV['ON']}'");		// SQL en estructura/conecta.php
		...
		//list( $_HOST, $_USERNAME,$_PASSWORD ) = qRecord( "select server, user,pass from gesco_cnfg_emisor where cnfg_default='{$_ENV['ON']}'" ); 
		...
		$err_general=0;
		//if(SESS::$_Development) $_to='ojkare@gmail.com';
