...
?>
location.replace("edes.php?E:$t/create_css_ini.php&_NEXT='<?=$NEXT?>'&_SESS_=<?=$_GET["_SESS_"]?>");
<?PHP
}
echo "</script>";
exit;
...
echo '<br>';
?>
<FORM accept-charset="utf-8" METHOD=POST action="edes.php?E:$t/create_css_ini.php&_NEXT=<?=$NEXT."&_SESS_=".$_GET["_SESS_"]?>" style="display:none">
