...
}else if( SESS::$UploadFile['BoxSize']>0 ){
if( $CNTCheck ){
eTrace('Sistema Manual');
eTrace('pth: '.eGetCWD());
eTrace('BoxDir: '.SESS::$UploadFile['BoxDir']. ' - '.gettype(SESS::$UploadFile['BoxDir']));
}
if( gettype(SESS::$UploadFile['BoxDir'])=="string" ){
$checkDir = array(SESS::$UploadFile['BoxDir']);
}else{
$checkDir = SESS::$UploadFile['BoxDir'];
}
$TotalByts = 0;
...
$sf = SESS::$UploadFile['BoxSize']*$UnGiga - $TotalByts;
$st = SESS::$UploadFile['BoxSize']*$UnGiga;
if( $CNTCheck ){
eTrace('BoxSize: '.SESS::$UploadFile['BoxSize']);
eTrace('Tipo: '.$Tipo);
